AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    for (var i = 1; i <= numOfElectron; i++) {
      ...
      orbit.setAttribute("material", "color", "#ff9e80");
      orbit.setAttribute("position", { x: 0, y: 1, z: 0 });

      orbit.setAttribute("rotation", { x: 0, y: Oangle, z: 0 });
      Oangle += 45
      atom.appendChild(orbit)
      var electronGroup = document.createElement('a-entity')
      electronGroup.setAttribute("id", `electron-grup-${elementName}`)
      electronGroup.setAttribute("rotation", { x: 0, y: 0, z: Eangle })
      ...
      electron.setAttribute("material", "color", "#0d47a1");
